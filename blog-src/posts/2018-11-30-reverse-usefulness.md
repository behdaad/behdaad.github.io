---
layout: base.njk
title: مفید بودن، تغییر و افسردگی (در جهت برعکس)
date: 2018-11-30
tags: [فارسی]
tagsLabel: برچسب‌ها
readMore: ادامه مطلب
...
> اگر هنوز دانشجوی کارشناسی هستید، یادتون باشه که اگر بعد از فارغ‌التحصیلی، فقط چیزهایی که تو دانشگاه بهتون یاد داده‌ن رو بلدید، ۱-۲ سال از عمرتون رو تلف کرده‌ید. (از
>
> آنچه که از مطالعه برای کنکور ارشد فهمیدم
>
> )
...
- سعی می‌کنم ۸:۲۰ به سمت شرکت راه بیفتم. پیاده تقریباً ۴۰ دقیقه راهه و حدود ساعت ۹ می‌رسم شرکت. سر راه صبحانه می‌خرم و توی مسیر برنامه‌ی رادیویی [It's Electric](https://itunes.apple.com/us/curator/its-electric/1218413400) رو گوش می‌دم، چون علی‌رغم علاقه‌ی زیادم به موسیقی، صبح زود حوصله‌ی یه‌بند موسیقی گوش کردن ندارم، و خوبی این برنامه اینه که توش علاوه بر پخش موسیقی با سبک‌های مختلف، حرف هم زده می‌شه و باعث می‌شه خوابم بپره و سرحال‌تر شم.
- وقتی می‌رسم شرکت، اولین کار اینه که قهوه بریزم و هم‌زمان با چک کردن ایمیل‌هام صبحانه بخورم. من به Inbox Zero معتقدم، واسه همین صفر کردن اینباکس برام لذت‌بخشه. به طور خلاصه روش Inbox Zero می‌گه که اگر کارتون با ایمیلی تموم شد، اون رو آرشیو کنید و تو اینباکس‌تون فقط ایمیل‌هایی باشه که هنوز باهاشون کار دارید.
- بعد از تموم شدن صبحانه، یه Planning سریع برای اون روز انجام می‌دم. سعی می‌کنم تعداد کارهایی که برای هر روز در نظر می‌گیرم بیشتر از ۳ کار نشه تا بتونم تمرکز کافی رو روی هر کار داشته باشم. باید به مرور سرعت کار خودتون رو بسنجید، تا بتونید به اندازه‌ی توان‌تون کار در نظر بگیرید تا آخر روز با حس بد شرکت رو ترک نکنید. حس کارهای عقب‌مونده برای من خیلی بده و تا وقتی کاری رو کامل انجام ندم ذهنم آروم نمی‌گیره. سعی کنید اوایل خیلی سخت نگیرید تا از خودتون ناامید نشید، به مرور تخمین‌هاتون دقیق می‌شه. البته اگر شما هم برنامه‌نویسید...

![](https://files.virgool.io/upload/users/934/posts/kua6uawjsy17/iorfzkkgfvpz.jpeg)

- مهم‌ترین قسمت برنامه‌ی روزانه‌ی من اینجاست: انجام پروژه‌های شخصی و جانبی تا ساعت ۱۰. چون کارهای جانبی ددلاین‌های محکمی ندارن و بیشتر جنبه‌ی یادگیری دارن، شما هیچ‌وقت موقع انجام دادن‌شون استرس ندارید و همین باعث می‌شه لذت‌بخش باشن. این‌طوری روزتون رو هم با یه پاداش بزرگ، یعنی لذت ناشی از انجام کارهای جانبی، شروع کرده‌ید و این باعث می‌شه در ادامه‌ی روز بتونید مفیدتر کار کنید.
- ساعت ۱۰ جلسه‌ی روزانه‌ی شرکته که معمولاً بیشتر از ۱۵ دقیقه طول نمی‌کشه و بعدش تا ساعت ۱۱ از مواردی که توی لیست مطالعه‌م گذاشته‌م مطلب و مقاله می‌خونم. من از Reading List که خود Safari داره استفاده می‌کنم، اما نرم‌افزارهای زیادی مثل [Pocket](https://getpocket.com/) و [Instapaper](https://www.instapaper.com/) وجود دارن که به کمک اون‌ها می‌تونید لینک‌های جالبی که می‌خواید بعداً بخونید رو ذخیره کنید.
- از ساعت ۱۱ تا حدود ۹-۱۰ شب هم کار می‌کنم. گاهی شرکت شام می‌خورم، گاهی هم خونه، ولی معمولاً وقتی می‌رسم خونه دیگه انرژی‌ای برام برای کار مفید نمونده و ۱-۲ ساعت قبل از خواب به توییتر و یوتوب و به طور کلی وقت‌تلف‌کردن می‌گذره تا خوابم ببره.
